    ...
    <ul class="learn-press-nav-tabs course-nav-tabs">
        ...
        <?php foreach ( $tabs as $key => $tab ) { ?>
            ...
            <li class="<?php echo join( ' ', $classes ); ?>">
				<a href="?tab=<?php echo esc_attr( $tab['id'] ); ?>" data-tab="#<?php echo esc_attr( $tab['id'] ); ?>">
					<?php 
					if($tab['title'] == 'Overview'){ ?>
						<i class="fas fa-file-alt"></i>
						<?php
					}else if($tab['title'] == 'Curriculum'){ ?>
						<i class="fas fa-book"></i>
						<?php
					}else if($tab['title'] == 'Instructor'){ ?>
						<i class="fas fa-user"></i>
						<?php
					}else if($tab['title'] == 'Reviews'){ ?>
						<i class="fas fa-comments"></i>
						<?php
					} ?>
				   
				   <?php echo esc_attr($tab['title']); ?></a>
            </li>
